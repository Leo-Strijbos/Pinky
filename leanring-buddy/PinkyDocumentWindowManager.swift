//
//  PinkyDocumentWindowManager.swift
//  leanring-buddy
//
...
private final class PinkyDocumentWindowPanel: NSPanel {
    override var canBecomeKey: Bool { true }
}

@MainActor
final class PinkyDocumentWindowManager {
    private var panel: PinkyDocumentWindowPanel?
    private var currentSources: [SkillSourceDocument] = []

    func show(sources: [SkillSourceDocument]) {
    ...
    private func refreshPanelContent() {
        ...
        let documentView = PinkyDocumentPanelView(
    ...
    private func createPanel() {
        let placeholderView = PinkyDocumentPanelView(
            sources: [],
            onClose: { [weak self] in
                self?.hide()
            },
        ...
        let documentPanel = PinkyDocumentWindowPanel(
