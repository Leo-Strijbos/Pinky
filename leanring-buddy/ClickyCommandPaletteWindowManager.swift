//
//  ClickyCommandPaletteWindowManager.swift
//  leanring-buddy
//
...
private final class ClickyCommandPalettePanel: NSPanel {
    override var canBecomeKey: Bool { true }
    override var canBecomeMain: Bool { true }
}

@MainActor
final class ClickyCommandPaletteWindowManager: ObservableObject {
    static let barWidth: CGFloat = 620
    static let barHeight: CGFloat = 56

    private weak var companionManager: CompanionManager?
    private var panel: ClickyCommandPalettePanel?
    ...
    private func createPanel() {
        ...
        let commandPanel = ClickyCommandPalettePanel(
    ...
    private func makeHostingView(companionManager: CompanionManager) -> NSHostingView<ClickyCommandPaletteView> {
        NSHostingView(
            rootView: ClickyCommandPaletteView(windowManager: self)
        )
    }
