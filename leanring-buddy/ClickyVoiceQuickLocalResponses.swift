//
//  ClickyVoiceQuickLocalResponses.swift
//  leanring-buddy
//
...
enum ClickyVoiceQuickLocalResponses {
    ...
    static func match(transcript: String) -> String? {
        ...
        let acknowledgementChecks = [
            ...
            "sounds good", "fair enough", "thanks", "thank you", "thank you clicky",
        ]
        ...
        let capabilityChecks = [
            ...
            "what are you able to do", "what can clicky do",
        ]
