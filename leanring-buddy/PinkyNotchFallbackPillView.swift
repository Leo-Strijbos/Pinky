//
//  PinkyNotchFallbackPillView.swift
//  leanring-buddy
//
...
@MainActor
final class PinkyNotchFallbackPillModel: ObservableObject {
...
struct PinkyNotchFallbackPillView: View {
    @ObservedObject var model: PinkyNotchFallbackPillModel
    ...
    private var leadingFlank: some View {
        PinkyNotchIdleHandView(size: 16, isIdle: model.voiceState == .idle)
