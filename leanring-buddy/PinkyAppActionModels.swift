...
enum PinkySpotifyPlaybackControl: Equatable {
    case play
    case pause
    case playPause
    case next
...
enum PinkyKnownApplication {
    ...
    static func isBrowser(_ normalizedName: String) -> Bool {
        PinkyURLActionParser.isBrowser(normalizedName)
    }
}
