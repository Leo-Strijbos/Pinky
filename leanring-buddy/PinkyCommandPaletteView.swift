...
struct PinkyCommandPaletteView: View {
    @ObservedObject var windowManager: PinkyCommandPaletteWindowManager
    ...
    var body: some View {
        HStack(spacing: 12) {
            ...
            TextField("Ask Pinky anything…", text: $windowManager.queryText)
