//
//  ClickyOpenAppActionHandler.swift
//  leanring-buddy
//
...
struct ClickyOpenAppActionHandler: ClickyAppActionHandling {
    ...
    static func openApplication(named normalizedName: String) -> String {
        let displayName = ClickyKnownApplication.displayName(for: normalizedName)

        if let bundleIdentifier = ClickyKnownApplication.bundleIdentifiers[normalizedName],
